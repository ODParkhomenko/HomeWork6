...
class Student:
    ...
    def __str__(self):
        '''для преобразования списка self.courses_in_progress в строку использован  ", ".join()   '''
...
first_student.get_average_student_rating(first_student.grades)#передача словаря с оценками в метод get_average_student_rating класса Student для 1-го студента
